...
def main():
    ...
    reform_tpi = safe_read_pickle(
        os.path.join(reform_educ_dir, "TPI", "TPI_vars.pkl")
    )
    reform_params = safe_read_pickle(
        os.path.join(reform_educ_dir, "model_params.pkl")
    )
    ans = ot.macro_table(
        base_tpi,
        base_params,
    ...
    op.plot_all(
        base_dir, reform_educ_dir, os.path.join(reform_educ_dir, "educ_plots")
    )

    print("Percentage changes in aggregates:", ans)
    # save percentage change output to csv file
    ans.to_csv(os.path.join(reform_educ_dir, "educ_output.csv"))    
